<footer>
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-4">
        <h4 style="color: #000000"><strong>Dirección sede Miravalle</strong></h4>
        <p style="color: white">
        ...
        <div class="col-sm-4">
            <h4 style="color: #000000"><strong>Dirección sede CCD</strong></h4>
            <p style="color: white">
                Independencia 55, Colonia Centro<br>
                Ciudad: Guadalajara<br>
                Telefono: (52) 33 3030 0900 <br>
                E-mail: <a href="#">soporte@utj.edu.mx</a>
            </p>
