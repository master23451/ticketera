...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php"><i class="fa fa-spinner fa-spin" style="font-size:30px;color:green"></i>&nbsp;&nbsp;Universidad Tecnologica Jalisco</a>
        </div>
      ...
      <div class="modal-content">
          ...
          <form action="" method="POST" style="margin: 20px;">
              <div class="form-group">
                  ...
                  <input type="email" class="form-control" name="correo_login" placeholder="Escriba su correo" required=""/>
              </div>
              <div class="form-group">
