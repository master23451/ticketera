                    ...
                    <div class="col-sm-8">
                      <form class="form-horizontal" role="form" action="" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <input type="text" class="form-control" placeholder="Nombre" required="" pattern="[a-zA-Z ]{1,30}" name="name_ticket" title="Nombre Apellido" value='<?php echo $_SESSION['nombre']?>'>
                          ...
                          <div class="col-sm-10">
                              <div class='input-group'>
                                <select class="form-control" name="departamento_ticket">
								  ...
								  <option value="Roberto">Ramon</option>
								  <option value="Roberto">Adolfo</option>
                                </select>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-10">
                            <textarea class="form-control" rows="3" placeholder="Escriba el problema que está presentando" name="mensaje_ticket" required=""></textarea>
                          </div>
                        </div>
