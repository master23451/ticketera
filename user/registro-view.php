<?php
    if(isset($_POST['user_reg']) && isset($_POST['clave_reg']) && isset($_POST['nom_complete_reg'])){
        ...
        $asunto="Registro de cuenta en Soporte UTJ";
        $cabecera="From: Soporte UTJ<soporte@utj.edu.mx>";
        $mensaje_mail="Hola ".$nombre_reg.", Gracias por registrarte en Soporte UTJ . Los datos de cuenta son los siguientes:\nNombre Completo: ".$nombre_reg."\nNombre de usuario: ".$user_reg."\nClave: ".$clave_reg2."\nEmail: ".$email_reg."\n Página principal: http://192.168.3.35/ticket/index.php";
        ...
        if(MysqlQuery::Guardar("cliente", "nombre_completo, nombre_usuario, email_cliente, clave", "'$nombre_reg', '$user_reg', '$email_reg', '$clave_reg'")){
            ...
            echo '
                <div class="alert alert-info alert-dismissible fade in col-sm-3 animated bounceInDown" role="alert" style="position:fixed; top:70px; right:10px; z-index:10;"> 
                    ...
                    <p class="text-center">
                        Cuenta creada exitosamente, ahora puedes iniciar sesión, ya eres usuario de Soporte UTJ.
                    </p>
                </div>
            ';
        }else{
