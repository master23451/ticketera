        ...
        <div class="container">
          <div class="row well">
            ...
            <div class="col-sm-9 lead">
              <h2 class="text-info">Bienvenido a la configuración de cuenta Soporte UTJ</h2>
              <p>Puedes <strong>actualizar los datos</strong> de tu cuenta ó puedes <strong>eliminar tu cuenta</strong> permanentemente si ya no deseas ser usuario de Soporte UTJ</p>
            </div>
          </div><!--Fin row well-->
              ...
              <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="Nombre de usuario actual" name="old_user_update" required="" pattern="[a-zA-Z0-9 ]{1,30}" title="Ejemplo7" maxlength="20" value="<?php echo $_SESSION['nombre'] ?>">
                    </div>
